...
CONTACT_SIDEBAR_AVATAR_SIZE = 36
CONTACT_SIDEBAR_ITEM_HEIGHT = 56
CONTACT_SIDEBAR_ITEM_PADDING = 8
CONTACT_SIDEBAR_CONTENT_GAP = 8
CONTACT_SIDEBAR_TEXT_TOP_OFFSET = 0
CONTACT_SIDEBAR_TEXT_SPACING = 0
