...
from PySide6.QtWidgets import QVBoxLayout, QScrollArea, QLabel, QPushButton, QHBoxLayout, QFrame
...
class ImageViewer(FluentDialog):
    """
    Image viewer dialog.
    ...
    def __init__(self, image_path: str, parent=None):
        super().__init__(parent, title=tr("image_viewer.title", "Image Viewer"))
