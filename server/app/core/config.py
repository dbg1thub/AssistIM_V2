...
class Settings:
    ...
    api_compat_prefix: str = field(default_factory=lambda: _env_str("API_COMPAT_PREFIX", "/api"))
    enable_legacy_chat_http: bool = field(default_factory=lambda: _env_bool("ENABLE_LEGACY_CHAT_HTTP", True))
    enable_legacy_chat_ws: bool = field(default_factory=lambda: _env_bool("ENABLE_LEGACY_CHAT_WS", True))
