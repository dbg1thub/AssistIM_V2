...
class FriendRepository:
    ...
    def create_request(self, sender_id: str, receiver_id: str, message: str | None = None) -> FriendRequest:
    ...
    def create_friendship_pair(self, user_id: str, friend_id: str) -> None:
