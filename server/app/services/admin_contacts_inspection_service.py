...
class AdminContactsInspectionService:
    ...
    def build_health(
        ...
        *,
        ...
        issues = self._health_issues(user_ids=user_ids, friendships=friendships, requests=requests)
        payload = {
    ...
    def _issue_sort_key(self, issue: dict[str, Any]) -> tuple[str, str, str, str]:
        return (
            ...
            str(issue.get("friend_id") or issue.get("receiver_id") or ""),
            str(issue.get("friendship_id") or issue.get("request_id") or ""),
        )
