...
11. [ai_action_workflow_design.md](./design/ai_action_workflow_design.md)
    查看 AI 助手自然语言动作编排、原子 action、可恢复执行器与确认/追问机制设计。
12. [code_review_guide.md](./engineering/code_review_guide.md)
    查看当前项目的 code review 检查顺序与输出格式。
13. [review_findings_grouped.md](./reviews/review_findings_grouped.md)
    查看按问题簇归并后的 review 结论与修复优先级。
14. [review_findings.md](./reviews/review_findings.md)
...
- [ai_action_workflow_design.md](./design/ai_action_workflow_design.md)
  AI 助手自然语言动作编排、原子 action、可恢复执行器与确认/追问机制设计。
