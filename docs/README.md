...
3. [realtime_protocol.md](./realtime_protocol.md)
...
8. [pitfalls.md](./pitfalls.md)
   查看本仓库反复出现的反模式与历史坑位。
9. [chat_e2ee_calls_design.md](./chat_e2ee_calls_design.md)
   查看聊天端到端加密与 1:1 语音 / 视频通话的增量设计草案与路线图。
10. [code_review_guide.md](./code_review_guide.md)
    查看当前项目的 code review 检查顺序与输出格式。
11. [review_findings_grouped.md](./review_findings_grouped.md)
    查看按问题簇归并后的 review 结论与修复优先级。
12. [review_findings.md](./review_findings.md)
...
- [chat_e2ee_calls_design.md](./chat_e2ee_calls_design.md)
  E2EE / 1:1 通话的增量方案、取舍、开放问题和分阶段落地顺序。
- [code_review_guide.md](./code_review_guide.md)
  review 执行方法，不定义正式架构。
- [review_findings_grouped.md](./review_findings_grouped.md)、[review_findings.md](./review_findings.md)
...
1. [design_decisions.md](./design_decisions.md)
   不可随意绕过的架构决策记录。
2. [architecture.md](./architecture.md)、[backend_architecture.md](./backend_architecture.md)、[realtime_protocol.md](./realtime_protocol.md)、[ui_guidelines.md](./ui_guidelines.md)
